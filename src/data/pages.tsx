...
// 3. Reemplaza los elementos de este array por etiquetas <img> apuntando a tus URLs.
// 
// EJEMPLO CON CLOUDINARY:
// export const dossierPages: React.ReactNode[] = [
//   <img src="https://res.cloudinary.com/tu-usuario/image/upload/v1234/portada.png" className="w-full h-full object-contain bg-white select-none" draggable={false} />,
//   <img src="https://res.cloudinary.com/tu-usuario/image/upload/v1234/pagina-1.png" className="w-full h-full object-contain bg-white select-none" draggable={false} />,
//   <img src="https://res.cloudinary.com/tu-usuario/image/upload/v1234/pagina-2.png" className="w-full h-full object-contain bg-white select-none" draggable={false} />,
//   <img src="https://res.cloudinary.com/tu-usuario/image/upload/v1234/contraportada.png" className="w-full h-full object-contain bg-white select-none" draggable={false} />
// ];
// ============================================================================
